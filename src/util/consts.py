class Consts:
    ...
    dgscene_sanctioned_event_xpath = """
        //div[contains(@class, "tournament-list list-record")]//a[contains(string(), "{year}")]
    """

    dgscene_course_tournament_link_xpath = (
        '//a[contains(@href, "/tournaments") and contains(@href, "/course")]'
    )
    ...
    pdgalive_score_page_specific_division_and_round_url = (
        pdgalive_base_url
    ...
    pdgalive_division_xpath = (
        '//div[contains(@class, "division-picker")]//button[not(text()="Leaders")]'
    )
    pdgalive_round_xpath = '//a[contains(string(), "Rd")]'
    pdgalive_round_course_metadata_text_xpath = (
        '//div[contains(@class, "round-course-meta")]//text()'
    )
    pdgalive_layout_hole_headers_xpath = (
        "//div[contains(@class, 'header-row')]//div[contains(@id, 'hole')]"
    )
    pdgalive_layout_distances_xpath = (
        "//div[contains(@class, 'header-row')]//div[contains(@id, 'hole')]//span"
    )

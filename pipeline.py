...
course_events = {
    ...
    } for course in list(course_names.keys())[0:100]
}
with open('course_events.json', 'w') as f:
...
with open('course_events.json') as f:
...
with open('course_ratings.json', 'w') as f:
...
with open('course_events.json') as f:
    course_events: dict = json.load(f)
with open('course_ratings.json') as f:
